...
<body>
	<div class="container">
	<form class="form-horizontal" name="JoinForm" method="post" action="/Join/JoinUpdate" onsubmit="return check()">
             ...
             -->  
				...
				<div class="form-group">
					<div class = "col-sm-offset-2 col-sm-10">
						<button type="submit" class="btn btn-success btn-lg" id="submit">회원정보 수정</button>		
						<button type="reset" class="cancle btn btn-danger btn-lg">취소 </button>
					</div>		
				</div>	
			</form>
		</div>		
...
$(document).ready(function(){
	...
	$("#submit").on("click", function(){
		...
		*/
		...
		alert("수정이 완료 되었습니다. 다시 로그인 하여 주세요.");
	})
})
